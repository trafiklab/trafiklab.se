...
| stop_groups                          | StopGroup[]   | The stop groups which are included in the query, one or more.                                                                                                                                      |
| stop_groups.id                       | String        | The stop group id.                                                                                                                                                                                 |
| stop_groups.name                     | String        | The stop group name.                                                                                                                                                                               |
| stop_groups.area_type                | String        | The stop group area type (metastop or rikshallplats).                                                                                                                                              |                                                                                                          
| stop_groups.average_daily_stop_times | Float         | The average daily departures from the stop area.                                                                                                                                                   |
| stop_groups.transport_modes          | String[]        | Transport modes stopping at this stop. This is based on actual traffic in the current timetable period. If a stop does not have traffic in the current timetable period, this array will be empty. |
| stop_groups.stops                    | Stop[]        | Child stops included in the stop group.                                                                                                                                                            |
