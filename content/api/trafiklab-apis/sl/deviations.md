...
| priority.importance_level            | Integer             | The importance level of the deviation message, **only used to sort messages**. The importance gives a presentation system a hint of what message to present first.     | 2                                                                                      |
