...
| [Trafiklab Realtime APIs](/api/our-apis/trafiklab-realtime-apis/_index.md) |     Json     |       ✅        |                                                   ✅                                                    | Departure & Arrival board API, Trip details API, Stop lookup API                                          |
| [ResRobot Stolptidstabeller](/api/our-apis/resrobot-v21/timetables.md)     |  Json, XML   |       ✅        |                                                   ❌                                                    | Departure & Arrival board API                                                                             |
