...
weight: 200
date: 2015-06-24
aliases: /apis/resrobot-reseplanerare/djuplankning-0
---
...
| --------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| S         | Either `S` or `SID` are required      | _extId_ for the origin stop. This id can be obtained through [the stop lookup API](http://localhost:1313/apis/trafiklab-apis/resrobot-v2/stop-lookup/) or [the nearby stops API](http://localhost:1313/apis/trafiklab-apis/resrobot-v2/nearby-stops/). Can not be used in combination with the `SID` parameter.                                                                                              | 740000044 (for Helsingborgs Centralstation) |
