...
our [GTFS Sverige 2](/api/gtfs-datasets/gtfs-sverige-2/)
or [GTFS Regional](/api/gtfs-datasets/gtfs-regional/) datasets.
...
our [GTFS Sverige 2](/api/gtfs-datasets/gtfs-sverige-2/)
or [GTFS Regional](/api/gtfs-datasets/gtfs-regional/) datasets as a datasource.

### Client-side route-planning

If you need client-side route-planning, you can use
our [GTFS Sverige 2](/api/gtfs-datasets/gtfs-sverige-2/)
or [GTFS Regional](/api/gtfs-datasets/gtfs-regional/) datasets as a datasource and
